...
echo "run eval "\"$(dirname "$0")/../bin/ant\"" "$ANT_PROPS" -f "\"${0%/*}/prpcServiceUtilsWrapper.xml\"" performOperation 2>&1 \| tee "$logfile""
echo "*********************************"
echo "run eval "$ANT_HOME/bin/ant" "$ANT_PROPS" -f "\"${0%/*}/prpcServiceUtilsWrapper.xml\"" performOperation 2>&1 \| tee "$logfile""
echo "*********************************"
run eval "$ANT_HOME/bin/ant" "$ANT_PROPS" -f "\"${0%/*}/prpcServiceUtilsWrapper.xml\"" performOperation 2>&1 \| tee "$logfile"
